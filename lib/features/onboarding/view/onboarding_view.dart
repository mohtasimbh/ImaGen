...
class _OnBoardingViewState extends State<OnBoardingView> {
  ...
  List<String> text = [
    "SEARCH FOR YOUR INNOVATION DESIGN",
    "NO LIMITS TO YOUR IMAGINATION",
    "CREATE YOUR OWN WALLPAPER"
  ];
  List<String> subtitle = [
    "Design a website landing page for a woman in tech metaverse event",
    "A thunderstorm of color over a city, pale colors, cinematic, ultra realistic,",
    "A thunderstorm of color over a city, pale colors, cinematic, ultra realistic,"
  ];
